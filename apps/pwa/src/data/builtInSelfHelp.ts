import type { SelfHelp } from '../graph/sharepointLists';

/**
 * Same built-in LE / agency self-help as SPFx; merged with Graph-fetched list items.
 */
export const BUILT_IN_SELF_HELP_GRAPH: SelfHelp[] = [
  {
    id: 'builtin--1',
    fields: {
